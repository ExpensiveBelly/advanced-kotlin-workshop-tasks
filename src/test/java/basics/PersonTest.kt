...
class PersonTest {
    ...
    fun testBusinessmanGreetText() {
        ...
        val businessman = Businessman(name2, 12)
        Assert.assertEquals(
            "Hello, my name is $name1, nice to see you $name2",
            Businessman(name1, 30).cheerText(businessman)
        )
        Assert.assertEquals(
            "Hello, my name is $name2, nice to see you $name1",
            Businessman(name2, 30).cheerText(student)
        )
    }
}